...
bool valueÑomparison(std::vector<int>& vec, std::array<int, 100000>& arr, int i) {
    auto start = std::chrono::high_resolution_clock::now();
...
bool valueÑomparisonVvV(std::vector<int>& vec1, std::vector<int>& vec2, int i) {
    auto start = std::chrono::high_resolution_clock::now();
...
bool valueÑomparisonAvA(std::array<int, 100000>& arr1, std::array<int, 100000>& arr2, int i) {
    auto start = std::chrono::high_resolution_clock::now();
